...
export const usersTable: UserRow[] = [
  ...
  // ============================================================================
  {
    ...
    alternatePhone: '+254 733 100 001',
    alternateEmail: 'c.kirundi@gmail.com',
    employeeId: 'DIR-001',
    avatar: null,
  ...
  // 7. Board Member - Zone 5
  {
    ...
    firstName: 'John',
    lastName: 'Mithamo Wasusana',
    fullName: 'John Mithamo Wasusana',
  ...
  // ============================================================================
  {
    ...
    alternatePhone: '+254 733 300 001',
    alternateEmail: 'k.muhia@gmail.com',
    employeeId: 'CS-001',
    avatar: null,
    timezone: 'Africa/Nairobi',
    // Role name derived from userBoardRoles default assignment
  ...
  },
  {
    ...
    alternatePhone: '+254 733 300 002',
    alternateEmail: 'i.chege@outlook.com',
    employeeId: 'CS-002',
    avatar: null,
    timezone: 'Africa/Nairobi',
    // Role name derived from userBoardRoles default assignment
  ...
  {
    id: 24,
    email: 'estherosoro@ktdateas.com',
    firstName: 'Esther',
    lastName: 'Osoro',
    fullName: 'Esther Osoro',
    phone: '+254 722 100 003',
    alternatePhone: null,
    alternateEmail: null,
    employeeId: 'SEC-002',
